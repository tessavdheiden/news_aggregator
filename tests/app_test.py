...
class ExampleTestCase(unittest.TestCase):
    ...
    def test_get_summary(self):
        ...
        rv = app.test_client().get(f'/api/{id}', json={
            'id': id
        })

        self.assertIsInstance(rv.get_json()['summary'], str)
    ...
    def test_generate_summaries(self):
        ...
        self.assertEqual(rv.status_code, status.HTTP_416_REQUESTED_RANGE_NOT_SATISFIABLE)
